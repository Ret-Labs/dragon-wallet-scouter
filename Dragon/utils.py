...
def choices(chain: str):
    if chain.lower() == "solana":
        options: list = ["Custom Bulk Wallet Checker With Config", "Bundle Checker", "Bulk Wallet Checker", "Top Traders Scraper", "All Transaction Scan", "Get Transaction By Timestamp", "Copy Wallet Finder", "Top Holders Scraper", "Purge All Files", "Quit"]
